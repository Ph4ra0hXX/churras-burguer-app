  ...
  setup() {
    ...
    const Burger = ref({
      ...
      Adicionais: [
        ...
        { nome: "Cream Cheese", preco: 5.0, quantidade: 0 },
        { nome: "Bacon", preco: 3.0, quantidade: 0 },
        { nome: "Calabresa", preco: 3.0, quantidade: 0 },
        { nome: "Presunto Peru", preco: 3.0, quantidade: 0 },
        { nome: "Batata Palha", preco: 1.5, quantidade: 0 },
        { nome: "Milho Verde", preco: 1.5, quantidade: 0 },
...
<template>
  <div id="cardapio">
    <div id="listar">
      ...
      <div class="dotted-line">
        <hr />
        <span id="textDividers">Saladas</span>
        <hr />
      </div>
      <br />
